...
public class RdfPersistence {
     ...
     */
    public static boolean updateSemanticRepository(SailRepository repository, Vector<String> startingPointUrls, Vector<String> doNotImportTheseUrls, String resourceDir)
    ...
    */
    ...
    public static void dropContexts(SailRepository repository, Vector<String> dropList) {
        RepositoryConnection con = null;
     ...
     */
    private static Vector<String> findExternalInferencingContexts(SailRepository repository) {
        RepositoryConnection con = null;

    ...
    public void doPost(HttpServletRequest request,
        ...
        try {
            ...
            if (qcSOAPDocument(doc)) {
                ...
                Element soapEnvelope = new Element("Envelope",XMLNamespaces.getDefaultSoapEnvNamespace());
                Element soapBody = new Element("Body",XMLNamespaces.getDefaultSoapEnvNamespace());
                soapEnvelope.addContent(soapBody);
                mpr.setSoapEnvelope(soapEnvelope);


                log.error("Something Bad Happened while processing a SOAP request!");
                Element err = ExceptionElementUtil.makeExceptionElement(
                            "BadSoapRequest",
                            "Your SOAP request cannot be processed by this server.",
                            "SOAP Request Dispatch Handler"
                    );

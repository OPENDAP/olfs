...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:dap="http://xml.opendap.org/ns/DAP/3.2#">
    ...
    <xsl:template name="Summary">
        ...
        <xsl:variable name="titleAttribute"
                      select="/dap:Dataset/dap:Attribute[@name='NC_GLOBAL']/dap:Attribute[@name='title']"/>
        The Unidata Attribute Convention for Data Discovery provides recommendations for netCDF attributes that
        can be added to netCDF files to facilitate discovery of those files using standard metadata searches.
        This tool tests conformance with those recommendations. More<a
            href="https://www.nosc.noaa.gov/dmc/swg/wiki/index.php?title=NetCDF_Attribute_Convention_for_Dataset_Discovery#Conformance_Test">
        Information on Convention and Tool</a>.

        <p>
            <span class="large_bold">Title:</span>
            <span class="large"><xsl:value-of select="$titleAttribute/@value"/></span>
        </p>
        <p>
            <span class="large_bold">Total Score:</span>
            <span class="large"><xsl:value-of select="$spiralTotal"/>/<xsl:value-of select="$spiralMax"/></span>
        </p>
    </xsl:template>
    ...
    -
    -->
    <xsl:template name="GeneralCharacteristics">
    ...
    -
    -->
    <xsl:template name="ExtentSearch">
    ...
    -
    -->
    <xsl:template name="OtherExtentInfo">
    ...
    -
    -->
    <xsl:template name="CreatorSearch">
    ...
    -
    -->
    <xsl:template name="ContributorSearch">
    ...
    -
    -->
    <xsl:template name="PublisherSearch">

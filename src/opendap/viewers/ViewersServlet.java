...
public class ViewersServlet extends HttpServlet {
     ...
     * that defined them from the config document.
     *
     * @return A Vector of JwsHandlers that have been intialized and are ready to use.
     * @throws ServletException When things go poorly
     */
    /*
    private ConcurrentHashMap<String, JwsHandler> buildJwsHandlers(String resourcesDir, Element viewersConfig) throws ServletException {
        ...
        for (Object o : viewersConfig.getChildren("JwsHandler")) {
            ...
            jwsHandlers.put(jwsHandler.getServiceId(), jwsHandler);
        }
    ...
    */
    ...
    /**
       ...
       */
    /*
      private ConcurrentHashMap<String, WebServiceHandler> buildWebServiceHandlers(Element viewersConfig) throws ServletException {

          String msg;

          ConcurrentHashMap<String, WebServiceHandler> wsHandlers = new ConcurrentHashMap<String, WebServiceHandler>();

          log.debug("Building JwsHandlers");


          for (Object o : viewersConfig.getChildren("WebServiceHandler")) {
              Element handlerElement = (Element) o;
              String className = handlerElement.getAttribute("className").getValue();
              ...
              try {
                  ...
                  log.debug("Building Handler: " + className);
                  Class classDefinition = Class.forName(className);
                  webServiceHandler = (WebServiceHandler) classDefinition.newInstance();
              ...
              log.debug("Initializing Handler: " + className);
              webServiceHandler.init(handlerElement);


              wsHandlers.put(webServiceHandler.getServiceId(), webServiceHandler);
          }

          log.debug("WebServiceHandlers have been built.");
          return wsHandlers;

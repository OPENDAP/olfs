...
public class BesApi {
     ...
     * @param mt  The MediaType to use when encoding BES errors.
    ...
    public void getDDXDocument(String dataSource,
        ...
        writeDDX(dataSource,constraintExpression,xdap_accept,xmlBase,mt,ddxString);
    ...
    public void getDMRDocument(String dataSource,
        ...
        writeDMR(dataSource,qp,xmlBase,mt,ddxString);
    ...
    public void getPathInfoDocument(String dataSource, MediaType responseType, Document response)
            throws PPTException,
            BadConfigurationException,
            IOException,
            JDOMException, BESError {
        ...
        writePathInfoResponse(dataSource,responseType,pathInfoDocString);
    ...
    public void besTransaction(String dataSource,
        ...
        int bes_timeout_seconds = bes.getTimeout()/1000;
        request.getRootElement().addContent(0,setContextElement("bes_timeout",Integer.toString(bes_timeout_seconds)));
        bes.besTransaction(request, mt, os);
    }

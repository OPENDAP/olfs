...
public class BesGroup extends CyclicGroup<BES> {
    ...
    */
    ...
    public Document getGroupVersion() throws Exception {
    ...
    public TreeSet<String> getCommonDapVersions() throws Exception {

        Document groupVersionDoc = getGroupVersion();

        TreeSet<String> commonDapVersions = null;
        ...
        if (groupVersionDoc != null) {
            ...
            for(Object o_beselem : besGroupList){
                ...
                if(commonDapVersions==null){
                    commonDapVersions = new TreeSet<String>(dapVersions);
                }

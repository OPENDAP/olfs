...
public class DatasetScan  extends Dataset {
    ...
    public Catalog getCatalog(String catalogKey) throws JDOMException, BadConfigurationException, PPTException, IOException, SaxonApiException, BESError {
        ...
        if(besCatalogResourceId.endsWith(ServiceManager.DEFAULT_CATALOG_NAME)){
            besCatalogResourceId = besCatalogResourceId.substring(0,besCatalogResourceId.lastIndexOf(ServiceManager.DEFAULT_CATALOG_NAME));
        }
         */
        ...
        /*
        Replaced by catalogPath computation above
        if(catalogKey.endsWith(ServiceManager.DEFAULT_CATALOG_NAME))
            catalogKey = catalogKey.substring(0,catalogKey.length() - ServiceManager.DEFAULT_CATALOG_NAME.length());

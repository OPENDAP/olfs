 ...
 *
 */
public class IPLogger implements Runnable, IPLConfigReader {
     ...
     * if using raw mode.
     */
    public IPLogger(String ipAddr, int portNum,  String fname)   {
        this();
    ...
    public void logRawDataClassic(OutputStream os) throws IOException, InterruptedException{
        byte b;
    ...
    public void logRawDataNIO(OutputStream os) throws IOException, InterruptedException{
        byte b;
    ...
    private boolean processCmdLine(String args[]) throws  IOException {

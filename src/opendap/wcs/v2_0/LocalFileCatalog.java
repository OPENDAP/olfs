...
public class LocalFileCatalog implements WcsCatalog {
    ...
    private  ConcurrentHashMap<String,CoverageDescription> eoCoverages = new  ConcurrentHashMap<String,CoverageDescription>();
    private  DataSetSeries eoDataSetSeries = new DataSetSeries();
    ...
    public List<CoverageDescription> getCoverageDescriptionElements() {
    	...
    	return Collections.list(coverages.elements());
    }
    ...
    //public List<Element> getCoverageDescriptionElements() throws WcsException {
    public List<CoverageDescription> getEoCoverageDescriptionElements() {
        //throw new WcsException("getCoverageDescriptionElements() method Not Implemented",WcsException.NO_APPLICABLE_CODE);
    	return Collections.list(eoCoverages.elements());
    }

    
    public void setEoCoverageDescriptionElements(ConcurrentHashMap<String,CoverageDescription> ecovs)
    {
      this.eoCoverages = ecovs;	
    }
	...
	public DataSetSeries getEoDataSetSeries() {
		return eoDataSetSeries;
	}

	public void setEoDataSetSeries(DataSetSeries eoDataSetSeries) {
		this.eoDataSetSeries = eoDataSetSeries;
	}

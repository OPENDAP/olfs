...
It's complicated, so first I'll walk through a simplified narrative of the request/response operation and then add a couple of sections after regarding other parts of the operation.
